...
Foliage uses a separate two-texture WebGL pass. An invalid or missing foliage bundle restores the intact foreground and retains the dynamic sky. The original full paintings remain the WebGL/sky fallback. General bird/branch depth ordering and moving foliage shadows remain outside this version.
